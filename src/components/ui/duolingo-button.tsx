...
export const variantStyles = {
  ...
  icon: 'bg-emerald-600 text-white border-b-2 border-emerald-700 hover:bg-emerald-500 shadow-[0_3px_0_#065f46] focus:ring-emerald-600 p-0 flex items-center justify-center',
  destructive:
  ...
  emerald:
    'bg-emerald-600 text-white border bg-clip-padding border-b-2 border-emerald-700 hover:bg-emerald-500 shadow-[0_3px_0_#065f46] focus:ring-emerald-600',
  sky:
    'bg-sky-200 text-white border bg-clip-padding border-b-2 border-sky-200 hover:bg-sky-400 shadow-[0_3px_0_#0284c7] focus:ring-sky-500',
}
